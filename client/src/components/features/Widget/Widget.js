  ...
  render() {
    ...
    return (
      <nav className="widget">
        ...
        <p className={"sort " + (sort === "AUTHOR_ASC" ? "active" : "")} onClick={() => { sortProducts("AUTHOR_ASC")}} ><a>Last Name A&ndash;Z</a></p>
        <p className={"sort " + (sort === "AUTHOR_DESC" ? "active" : "")} onClick={() => { sortProducts("AUTHOR_DESC")}} ><a>Last Name Z&ndash;A</a></p>
